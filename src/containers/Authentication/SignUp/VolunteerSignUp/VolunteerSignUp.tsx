		...
		<>
			...
			<div className={styles.LoginSection}>
				<form onSubmit={props.onSubmit} className={styles.LoginForm}>
					...
					<label>
						<div className={styles.LoginFormLabel}>{translations.surname}</div>
						<div className={styles.LoginFormInput}>
							<input
								type="text"
					...
					<label>
						<div className={styles.LoginFormLabel}>{translations.email}</div>
						<div className={styles.LoginFormInput}>
							<input type="text" autoComplete="email" ref={emailRef} required />
						</div>
					</label>

					<label>
						<div className={styles.LoginFormLabel}>{translations.password}</div>
						<div className={styles.LoginFormInput}>
							<input
								type="password"
