...
import {onboardingOrganizationStepFieldTitle} from "../OrganizationOnboarding.translations";
...
const OrganizationOnboardingStep2 = ({
                                         availableFields,
                                         selectedFields,
                                         onChanged,
                                     }: Step2Props) => {
    ...
    return (
        <>
            <h2>{onboardingOrganizationStepFieldTitle}</h2>
...
export default OrganizationOnboardingStep2;
