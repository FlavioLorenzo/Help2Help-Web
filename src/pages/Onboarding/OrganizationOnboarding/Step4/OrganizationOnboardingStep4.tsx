import {
    onboardingOrganizationStepAvailabilitiesTitle,
...
const OrganizationOnboardingStep4 = ({selectedAvailabilities, onChanged}: Step4Props) => {
    ...
    return (
        <>
            <h2>{onboardingOrganizationStepAvailabilitiesTitle}</h2>
...
export default OrganizationOnboardingStep4;
